...
import com.hjrh.common.utils.DateUtils;
import com.hjrh.common.utils.httpclient.SimpleHttpParam;
import com.hjrh.common.utils.httpclient.SimpleHttpResult;
import com.hjrh.common.utils.httpclient.SimpleHttpUtils;
...
public class NotifyTask implements Runnable, Delayed {
    ...
    /**
     * 
     * 功能描述：计算任务允许执行的开始时间(executeTime)
     *
     * @author  吴俊明
     * <p>创建日期 ：2017年7月1日 上午11:36:46</p>
     *
     * @param record
     * @return
     *
